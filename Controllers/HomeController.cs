...
namespace WebApplication1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["ReturnURL"] = $"https://b718-1-162-108-143.jp.ngrok.io/Home/CallbackReturn"; //支付完成返回商店網址
            ViewData["CustomerURL"] = $"https://b718-1-162-108-143.jp.ngrok.io/Home/CallbackCustomer"; //商店取號網址
            ViewData["NotifyURL"] = $"https://b718-1-162-108-143.jp.ngrok.io/Home/CallbackNotify"; //支付通知網址
            ViewData["ClientBackURL"] = $"https://b718-1-162-108-143.jp.ngrok.io/Home";
            return View();
        }
